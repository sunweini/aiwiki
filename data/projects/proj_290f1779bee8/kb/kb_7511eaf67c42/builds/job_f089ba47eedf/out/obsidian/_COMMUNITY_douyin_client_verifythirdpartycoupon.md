...
# douyin_client_verifythirdpartycoupon
...
```dataview
TABLE source_file, type FROM #community/douyin_client_verifythirdpartycoupon
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_backend_internal_repository_stats_repo_go]]
...
## Top bridge nodes
- [[REFUNDS]] - degree 6, connects to 2 communities
...
- [[.CreateRefund()]] - degree 2, connects to 1 community