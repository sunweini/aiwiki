...
```dataview
TABLE source_file, type FROM #community/backend_internal_repository_order_repo_go
SORT file.name ASC
```

## Connections to other communities
- 18 edges to [[_COMMUNITY_service_activity_service_newactivityservice]]
- 7 edges to [[_COMMUNITY_service_douyinservice_querycouponfromplatform]]
...
- 1 edge to [[_COMMUNITY_backend_internal_model_douyin_go]]
