...
# backend_internal_model_gate_go
...
```dataview
TABLE source_file, type FROM #community/backend_internal_model_gate_go
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_backend_internal_model_payment_go]]
